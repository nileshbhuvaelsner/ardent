...
var ardentIsMobile = {
	...
	any: function () {
		return (
			ardentIsMobile.Android() ||
			ardentIsMobile.BlackBerry() ||
			ardentIsMobile.iOS() ||
			ardentIsMobile.Opera() ||
			ardentIsMobile.Windows()
		);
	}
};

function preload_images(images, complete_callback) {
	if (ardent_js_settings.hero_disable_preload) {
 ...
 *
 * Learn more: https://github.com/Automattic/Ardent/pull/136
 */
(function () {
...
jQuery(document).ready(function ($) {
	...
	var main_navigation = jQuery(".main-navigation .ardent-menu");
	...
	$document.on("click", "#nav-toggle", function (event) {
		...
		// Open menu mobile.
		if (!main_navigation.hasClass("ardent-menu-mobile")) {
			main_navigation.addClass("ardent-menu-mobile");
			$("body").addClass("ardent-menu-mobile-opening");
			setNavTop();
			...
			setTimeout(function () {
				main_navigation.animate(
					...
					function () {
						...
						main_navigation.removeClass("ardent-menu-mobile");
						$("body").removeClass("ardent-menu-mobile-opening");
					}
				);
			}, 40);
		}
	 ...
	 * @since 2.2.1
	 */
	if (!noSticky && ardentIsMobile.any()) {
	...
	function autoMenuAlign() {
		...
		$('#site-navigation  .ardent-menu > li').each(function () {
			const li = $(this);
	...
	$(window).resize(function () {
		...
		timeOutResize = setTimeout(() => {
			if (
				main_navigation.hasClass("ardent-menu-mobile") &&
	...
	jQuery(
		".ardent-menu li.menu-item-has-children, .ardent-menu li.page_item_has_children"
	).each(function () {
		jQuery(this).prepend(
	...
	if (ardent_js_settings.ardent_disable_sticky_header != "1") {
	...
	jQuery('#site-navigation li a[href*="#"]').on("click", function (
		...
		if (url.origin + url.pathname === window.location.origin + window.location.pathname) {
			...
			// if in mobile mod.
			if (jQuery(".ardent-menu").hasClass("ardent-menu-mobile")) {
	 ...
	 */
	if (ardent_js_settings.ardent_disable_animation != "1") {
		var wow = new WOW({
			offset: 50,
			mobile: false,
			live: false
	...
	var text_rotator = function () {
		...
		jQuery(".js-rotating").Morphext({
			...
			animation: ardent_js_settings.hero_animation,
			// An array of phrases to rotate are created based on this separator. Change it if you wish to separate the phrases differently (e.g. So Simple | Very Doge | Much Wow | Such Cool).
			separator: "|",
			// The delay between the changing of each phrase in milliseconds.
			speed: parseInt(ardent_js_settings.hero_speed),
			complete: function () {
	 ...
	 */
	if (ardent_js_settings.ardent_vertical_align_menu == "1") {
		var header_height = jQuery(".site-header").height();
		jQuery(".site-header .ardent-menu").css(
			"line-height",
			header_height + "px"
		);
	}
				...
				if (images) {
					preload_images(images, function () {
						hero.backstretch(images, {
							fade: _to_number(ardent_js_settings.hero_fade),
							duration: _to_number(
								ardent_js_settings.hero_duration
							)
						});
						//
	 ...
	 * Gallery
	 */
	function ardent_gallery_init($context) {
		// justified
		...
		var is_rtl = ardent_js_settings.is_rtl;
	...
	ardent_gallery_init($(".gallery-content"));
	
	
	if ( typeof jarallax !== "undefined" ) {
		jarallax(document.querySelectorAll('.jarallax'), {
			speed: parseFloat( ardent_js_settings.parallax_speed || 0.5 ),
	  });
	} 
