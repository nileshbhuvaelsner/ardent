...
(function ($, window, document, undefined) {
	...
	if (Ardent_Bully.disable_mobile) {
	...
	(function update() {
		if (frameRendered !== true) {
			...
			$.each(Ardent_Bully.sections, function (id, arg) {
				var element = $("#" + id);
			...
			if (
				lastItemId &&
				typeof Ardent_Bully.sections[lastItemId] !== "undefined"
			) {
				if (Ardent_Bully.sections[lastItemId].inverse) {
	...
	function Bully(element, options) {
		...
		if (Ardent_Bully.enable_label) {
			if (id && typeof Ardent_Bully.sections[id] !== "undefined") {
				label = Ardent_Bully.sections[id].title;
			}
			if (label) {
				$bullet.append(
	...
	$.each(Ardent_Bully.sections, function (id, args) {
		if (args.enable) {
			const section = $("#" + id);
			if (section.length) {
				section.bully({
